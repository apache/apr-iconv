...
static const iconv_ccs_convtable_8bit from_ucs_00 = { {
	...
	0x0018, 0x0019, 0x00FD, 0x0027, 0x001C, 0x001D, 0x001E, 0x001F,
	...
	0x00A7, 0x00A8, 0x00A9, 0x00C0, 0x006A, 0x00D0, 0x00A1, 0x0007,
	...
	0x0074, 0xFFFE, 0xFFFE, 0x00B0, 0xFFFE, 0xFFFE, 0x00DF, 0x00EB,
	0x0070, 0x00FB, 0xFFFE, 0x00EE, 0x00EF, 0x00CA, 0xFFFE, 0xFFFE,
	0x0090, 0x00DA, 0x00EA, 0x00FA, 0x00A0, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0x00FE, 0xFFFE, 0x00DB, 0xFFFE, 0xFFFE,
...
static const iconv_ccs_convtable_8bit from_ucs_03 = { {
	...
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0x0080, 0x0071, 0x00DD,
	0x0072, 0x0073, 0x0075, 0xFFFE, 0x0076, 0xFFFE, 0x0077, 0x0078,
	0x00CC, 0x0041, 0x0042, 0x0043, 0x0044, 0x0045, 0x0046, 0x0047,
	0x0048, 0x0049, 0x0051, 0x0052, 0x0053, 0x0054, 0x0055, 0x0056,
	0x0057, 0x0058, 0xFFFE, 0x0059, 0x0062, 0x0063, 0x0064, 0x0065,
	0x0066, 0x0067, 0x0068, 0x0069, 0x00B1, 0x00B2, 0x00B3, 0x00B5,
	0x00CD, 0x008A, 0x008B, 0x008C, 0x008D, 0x008E, 0x008F, 0x009A,
	0x009B, 0x009C, 0x009D, 0x009E, 0x009F, 0x00AA, 0x00AB, 0x00AC,
	0x00AD, 0x00AE, 0x00BA, 0x00AF, 0x00BB, 0x00BC, 0x00BD, 0x00BE,
	0x00BF, 0x00CB, 0x00B4, 0x00B8, 0x00B6, 0x00B7, 0x00B9, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
...
static const iconv_ccs_convtable_8bit from_ucs_20 = { {
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0x00CF, 0xFFFE, 0xFFFE,
	0x00CE, 0x00DE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
