...
static const iconv_ccs_convtable_7bit to_ucs = { {
	...
	0xFFFE, 0xFFFE, 0xFFFE, 0x007B, 0x007C, 0x007D, 0x203E, 0x007F
} };
...
static const iconv_ccs_convtable_8bit from_ucs_00 = { {
	...
	0x0028, 0x0029, 0x002A, 0x002B, 0xFFFE, 0x002D, 0x002E, 0x002F,
	0x0030, 0x0031, 0x0032, 0x0033, 0x0034, 0x0035, 0x0036, 0x0037,
	0x0038, 0x0039, 0x003A, 0xFFFE, 0x003C, 0x003D, 0x003E, 0xFFFE,
...
static const iconv_ccs_convtable_8bit from_ucs_06 = { {
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0x002C, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0x003B, 0xFFFE, 0xFFFE, 0xFFFE, 0x003F,
	...
	0x0070, 0x0071, 0x0072, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
