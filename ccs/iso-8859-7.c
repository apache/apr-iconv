...
static const iconv_ccs_convtable_8bit to_ucs = { {
	...
	0x00A0, 0x2018, 0x2019, 0x00A3, 0xFFFE, 0xFFFE, 0x00A6, 0x00A7,
	0x00A8, 0x00A9, 0xFFFE, 0x00AB, 0x00AC, 0x00AD, 0xFFFE, 0x2015,
	...
	0x03C8, 0x03C9, 0x03CA, 0x03CB, 0x03CC, 0x03CD, 0x03CE, 0xFFFE
} };
...
static const iconv_ccs_convtable_8bit from_ucs_00 = { {
	...
	0x0090, 0x0091, 0x0092, 0x0093, 0x0094, 0x0095, 0x0096, 0x0097,
	0x0098, 0x0099, 0x009A, 0x009B, 0x009C, 0x009D, 0x009E, 0x009F,
	0x00A0, 0xFFFE, 0xFFFE, 0x00A3, 0xFFFE, 0xFFFE, 0x00A6, 0x00A7,
	0x00A8, 0x00A9, 0xFFFE, 0x00AB, 0x00AC, 0x00AD, 0xFFFE, 0xFFFE,
	0x00B0, 0x00B1, 0x00B2, 0x00B3, 0xFFFE, 0xFFFE, 0xFFFE, 0x00B7,
	0xFFFE, 0xFFFE, 0xFFFE, 0x00BB, 0xFFFE, 0x00BD, 0xFFFE, 0xFFFE,
...
static const iconv_ccs_convtable_8bit from_ucs_03 = { {
	...
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0x00B4, 0x00B5, 0x00B6, 0xFFFE,
	0x00B8, 0x00B9, 0x00BA, 0xFFFE, 0x00BC, 0xFFFE, 0x00BE, 0x00BF,
	0x00C0, 0x00C1, 0x00C2, 0x00C3, 0x00C4, 0x00C5, 0x00C6, 0x00C7,
	0x00C8, 0x00C9, 0x00CA, 0x00CB, 0x00CC, 0x00CD, 0x00CE, 0x00CF,
	0x00D0, 0x00D1, 0xFFFE, 0x00D3, 0x00D4, 0x00D5, 0x00D6, 0x00D7,
...
static const iconv_ccs_convtable_8bit from_ucs_20 = { {
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0x00AF, 0xFFFE, 0xFFFE,
	0x00A1, 0x00A2, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
	0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE,
